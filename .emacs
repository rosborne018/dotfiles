...
(global-set-key (kbd "C-x C-r") 'load-file "/home/ryan/.emacs")
...
(require 'ocp-indent)
(require 'merlin)
(push "/home/ryan/.opam/system/share/emacs/site-lisp" load-path) ; directory containing merlin.el
(setq merlin-command "/home/ryan/.opam/system/bin/ocamlmerlin")  ; needed only if ocamlmerlin not already in your PATH
